...
```
openupm add net.tnrd.messagepack
```

2. Installing through a [Unity Package](http://package-installer.glitch.me/v1/installer/package.openupm.com/net.tnrd.messagepack?registry=https://package.openupm.com) created by the [Package Installer Creator](https://package-installer.glitch.me) from [Needle](https://needle.tools)

[<img src="https://img.shields.io/badge/-Download-success?style=for-the-badge"/>](http://package-installer.glitch.me/v1/installer/package.openupm.com/net.tnrd.messagepack?registry=https://package.openupm.com)
...
```
"net.tnrd.messagepack": "https://github.com/Thundernerd/Unity3D-messagepack.git"
```
